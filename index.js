...
/*The nested function can acess the internal variable because of the lexical scope of nestedFunction. Variables may be passed downwards but not upwards.
...
{
 return arr.map(x => x.animal_name.toLowerCase());
}
...
//const result = words.filter(word => word.length > 6);
  ...
  {
    return arr.filter(animal => animal.population < 5 )
  }
...
class CubeMaker extends CuboidMakerTwo
  ...
  const cublet = new CubeMaker(
    ...
    console.log(cublet.surfaceArea());
    console.log(cublet.volume());
